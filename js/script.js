$(document).ready(function(){
    ...
    */
    var myKey = "e3fa9814cd5935912d17009d30896d60";  //사이트로부터 받아온 API key를 저장
...
*/
        ...
        $("#weather ul li").each(function(index){  //0, 1, 2, ...
            $.ajax({
                ...
                success:function(data){
                    console.log(data);
                    console.log("현재 온도(℃) : " + Math.round(data.main.temp - 273.12));
                    var temp = Math.round(data.main.temp - 273.12);
                    ...
                    $("#weather li").eq(index).find(".cloud span").text(clouds);
    ...
    $(".cities button").click(function(){
        ...
        //city.push($city_txt);  //기존의 배열 데이터에 새로운 데이터를 추가한다.
...
//API Key : e3fa9814cd5935912d17009d30896d60
//api.openweathermap.org/data/2.5/weather?q=London&appid=e3fa9814cd5935912d17009d30896d60
